...
set service router-advert interface eth1 name-server 'fdd6:44d4:6900::69'
...
set service router-advert interface eth1.10 name-server 'fdd6:44d4:6900::69'
...
set service router-advert interface eth1.42 name-server 'fdd6:44d4:6900::69'
...
set service router-advert interface eth1.69 name-server 'fdd6:44d4:6900::69'
