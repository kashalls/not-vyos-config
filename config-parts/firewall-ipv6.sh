...
set firewall ipv6 name guest-local-v6 rule 51 action 'accept'
set firewall ipv6 name guest-local-v6 rule 51 description 'Rule: accept_ipv6_icmp'
set firewall ipv6 name guest-local-v6 rule 51 protocol 'ipv6-icmp'
...
set firewall ipv6 name iot-local-v6 rule 51 action 'accept'
set firewall ipv6 name iot-local-v6 rule 51 description 'Rule: accept_ipv6_icmp'
set firewall ipv6 name iot-local-v6 rule 51 protocol 'ipv6-icmp'
...
set firewall ipv6 name lan-local-v6 rule 51 action 'accept'
set firewall ipv6 name lan-local-v6 rule 51 description 'Rule: accept_ipv6_icmp'
set firewall ipv6 name lan-local-v6 rule 51 protocol 'ipv6-icmp'
...
set firewall ipv6 name servers-local-v6 rule 51 action 'accept'
set firewall ipv6 name servers-local-v6 rule 51 description 'Rule: accept_ipv6_icmp'
set firewall ipv6 name servers-local-v6 rule 51 protocol 'ipv6-icmp'
...
set firewall ipv6 name containers-local-v6 rule 51 action 'accept'
set firewall ipv6 name containers-local-v6 rule 51 description 'Rule: accept_ipv6_icmp'
set firewall ipv6 name containers-local-v6 rule 51 protocol 'ipv6-icmp'
...
set firewall ipv6 name trusted-local-v6 rule 51 action 'accept'
set firewall ipv6 name trusted-local-v6 rule 51 description 'Rule: accept_ipv6_icmp'
set firewall ipv6 name trusted-local-v6 rule 51 protocol 'ipv6-icmp'
