...
set firewall ipv4 name iot-local rule 200 destination group port-group multicast-udp
...
set firewall ipv4 name local-trusted rule 200 destination group port-group multicast-udp
