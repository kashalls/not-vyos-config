...
set firewall ipv4 forward filter rule 5 inbound-interface interface-name 'eth0'
set firewall ipv4 forward filter rule 5 jump-target 'wan-in'

set firewall ipv4 input filter default-action 'accept'
set firewall ipv4 input filter rule 5 action 'jump'
set firewall ipv4 input filter rule 5 inbound-interface interface-name 'eth0'
...
set firewall ipv4 name wan-local rule 31 inbound-interface group 'LAN'
