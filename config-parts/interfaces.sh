...
set interfaces ethernet eth0 dhcpv6-options pd 0 interface eth1.10 address '1'
set interfaces ethernet eth0 dhcpv6-options pd 0 interface eth1.10 sla-id '10'
set interfaces ethernet eth0 dhcpv6-options pd 0 interface eth1.42 address '1'
set interfaces ethernet eth0 dhcpv6-options pd 0 interface eth1.42 sla-id '42'
set interfaces ethernet eth0 dhcpv6-options pd 0 interface eth1.69 address '1'
set interfaces ethernet eth0 dhcpv6-options pd 0 interface eth1.69 sla-id '69'
