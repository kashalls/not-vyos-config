...
set service dhcp-server shared-network-name SERVERS subnet 10.69.0.0/24 subnet-parameters 'if exists user-class and (option user-class = &quot;iPXE&quot; or option user-class = &quot;Raspberry Pi Boot&quot;) {'
