...
set service dhcp-server shared-network-name SERVERS subnet 10.69.0.0/24 subnet-parameters '} else if exists user-class and option user-class = &quot;iPXE&quot; and option arch = 00:00:00:44 {'
set service dhcp-server shared-network-name SERVERS subnet 10.69.0.0/24 subnet-parameters '    filename &quot;http://10.5.0.8/boot.ipxe&quot;;'
set service dhcp-server shared-network-name SERVERS subnet 10.69.0.0/24 subnet-parameters '} else if option arch = 00:00:00:44 {'
set service dhcp-server shared-network-name SERVERS subnet 10.69.0.0/24 subnet-parameters '    filename &quot;http://10.5.0.8/boot.ipxe&quot;;'
