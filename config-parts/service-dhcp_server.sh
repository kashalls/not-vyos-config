...
set service dhcp-server shared-network-name SERVERS subnet 10.69.0.0/24 subnet-parameters 'else if option vendor-class-identifier = &quot;PXEClient:Arch:00011:UNDI:003000&quot; { filename &quot;ipxe-arm64.efi&quot;; }'
set service dhcp-server shared-network-name SERVERS subnet 10.69.0.0/24 subnet-parameters 'else if option vendor-class-identifier = &quot;PXEClient:Arch:00019:UNDI:003000&quot; { filename &quot;http://10.5.0.8/boot.ipxe&quot;; }'
# https://xunnanxu.github.io/2020/11/28/PXE-Boot-Diskless-Raspberry-Pi-4-With-Ubuntu-Ubiquiti-and-Synology-1-DHCP-Setup/
set service dhcp-server shared-network-name SERVERS subnet 10.69.0.0/24 subnet-parameters 'else if option arch = 00:00 { filename &quot;ipxe-arm64.efi&quot;; option vendor-class-identifier &quot;PXEClient&quot;; option vendor-encapsulated-options &quot;Raspberry Pi Boot&quot;; }'
