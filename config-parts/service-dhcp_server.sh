...
set service dhcp-server shared-network-name SERVERS subnet 10.69.0.0/24 subnet-parameters 'if option user-class = &quot;iPXE&quot; or substring (option vendor-class-identifier, 0, 9) = &quot;PXEClient&quot; {'
